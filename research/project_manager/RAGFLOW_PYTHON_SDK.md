...
- ​`term_similarity`​ `float`​ A keyword similarity score of the chunk ranging from `0`​ to `1`, with a higher value indicating greater similarity between keywords.
